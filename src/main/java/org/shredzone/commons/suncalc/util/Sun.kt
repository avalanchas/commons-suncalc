...
object Sun {
    ...
    fun positionEquatorial(date: JulianDate): Vector {
        ...
        val M = ExtendedMath.TAU * ExtendedMath.frac(0.993133 + 99.997361 * T)
        val L = ExtendedMath.TAU * ExtendedMath.frac(
            0.7859453 + M / ExtendedMath.TAU + (6893.0 * sin(M) + 72.0 * sin(2.0 * M) + 6191.2 * T) / 1296.0e3
        )
        val d = (SUN_DISTANCE
